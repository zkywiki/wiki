...
/* ============================================================
   ...
   이 위키가 무엇인지 알리는 문답. 개수는 자유롭게 늘리거나 줄여도 된다.
   답 안에서 줄을 바꾸려면 \n 을 넣는다 ("앞 문장.\n뒤 문장.").
   ============================================================ */
export const ABOUT = {
  title: "즈키위키란?",
  faq: [
    {
      q: "즈키위키는 무엇인가요?",
      a: "치지직 스트리머 즈키쿠의 방송 이야기를 모아 두는 비공식 팬 위키입니다.",
    },
    {
      q: "어떻게 참여하나요?",
      a: "수정이 필요한 내용을 우측 상단 '편집 제안' 버튼을 통해 보내 주시면 확인 후 반영합니다.\n모든 수정 요청은 익명으로 처리됩니다.",
    },
    {
      q: "언제까지 지속되나요?",
      a: "나무위키에 즈키쿠가 등재되는 날, 해당 페이지는 즈키쿠 나무위키 작성의 초석이 된 후 삭제될 예정입니다.",
    },
  ],
};
